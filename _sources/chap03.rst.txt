...
ここでは計算機でデータを扱うには必須となる変数とデータ型および基本的な計算の仕方について学ぼう．
    ...
    - :doc:`sample1.f90 <chap03_sample1>` : 変数の基本
    - :doc:`sample2.f90 <chap03_sample2>` : データ型と精度
    - :doc:`sample3.f90 <chap03_sample3>` : 定数
    - :doc:`sample4.f90 <chap03_sample4>` : ``read`` の使い方
    - :doc:`sample5.f90 <chap03_sample5>` : 算術演算，代入，組込み関数
    - :doc:`sample6.f90 <chap03_sample6>` : 型変換
